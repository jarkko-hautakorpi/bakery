...
// ... or update ITEM DATA
	...
	$database->query("UPDATE ".TABLE_PREFIX."mod_bakery_items SET section_id = '$section_id', page_id = '$page_id', title = '$title', link = '$item_link', `sku` = '$sku', `stock` = '$stock', `price` = '$price', `shipping` = '$shipping', `tax_rate` = '$tax_rate', `definable_field_0` = '$definable_field_0', `definable_field_1` = '$definable_field_1', `definable_field_2` = '$definable_field_2', `main_image` = '$main_image', `description` = '$description', `full_desc` = '$full_desc', active = '$active',$query_position modified_when = '".@mktime()."', modified_by = '".$admin->get_user_id()."' WHERE item_id = '$item_id'");
